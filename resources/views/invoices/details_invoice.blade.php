...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">List of the invoices</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    INVOICES DETIELS</span>
            </div>
        </div>
                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li><a href="#tab4" class="nav-link active" data-toggle="tab">Invoice inf</a></li>
                                                        ...
                                                        <form method="post" action="{{ url('/InvoiceAttachments') }}"
                                                            ...
                                                            <div class="custom-file">
                                                                ...
                                                                <input type="hidden" id="invoice_id" name="invoice_id"
                                                                    value="{{ $invoices->id }}">
                                                                <label class="custom-file-label" for="customFile">Locate
                                                                    Attached</label>
                                                            </div><br><br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">The Attachments Delete</h5>
