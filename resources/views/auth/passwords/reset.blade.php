									...
									<div class="main-card-signin d-md-flex">
										<div class="wd-100p">
												...
												<div class="">
                                                    ...
                                                    <form method="POST" action="{{ route('password.update') }}">
                                                        @csrf
															...
															<label>Email</label>
                                                                <input class="form-control" placeholder="Enter your email" type="email" @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                                                @error('email')
											...
											<div class="main-signup-footer mg-t-20">
												<p>Already have an account? <a href="{{ url('/' . $page='login') }}">login</a></p>
											</div>
										</div>
									</div>
								</div>
